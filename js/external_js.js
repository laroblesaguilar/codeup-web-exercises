...
function isShirtWord(input){
    return input.length < 5;
}

console.log(isShirtWord("Luis"));

function isSameLength(inputA, inputB){
    return inputA.length === inputB.length;
}

console.log(isSameLength("bye", "bye"));

function getSmallerSegment(input, num){
    var final = input.substring(0, num);
